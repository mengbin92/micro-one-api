...
func (c *identityServiceClient) GetAuthSnapshot(ctx context.Context, in *GetAuthSnapshotRequest, opts ...grpc.CallOption) (*GetAuthSnapshotReply, error) {
	...
	err := c.cc.Invoke(ctx, IdentityService_GetAuthSnapshot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityServiceClient) CreateAccessToken(ctx context.Context, in *CreateAccessTokenRequest, opts ...grpc.CallOption) (*CreateAccessTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityService_CreateAccessToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdentityServiceServer) GetAuthSnapshot(context.Context, *GetAuthSnapshotRequest) (*GetAuthSnapshotReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthSnapshot not implemented")
}

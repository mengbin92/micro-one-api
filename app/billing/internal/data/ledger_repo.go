...
func ledgerFromModel(model *ledgerModel) *biz.Ledger {
	...
	return &biz.Ledger{
		...
		ReportedPromptTokens:   model.ReportedPromptTokens,
		ReportedTotalTokens:    model.ReportedTotalTokens,
		BillableTotalTokens:    model.BillableTotalTokens,
		UsageSemantics:         model.UsageSemantics,
		UsageProtocol:          model.UsageProtocol,
		UsageFieldShape:        model.UsageFieldShape,
		UsageParseStatus:       model.UsageParseStatus,
		UsageContractVersion:   model.UsageContractVersion,
		CanonicalPresent:       model.CanonicalPresent,

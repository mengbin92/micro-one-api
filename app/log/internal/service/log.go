...
func (s *LogService) GetLog(ctx context.Context, req *logv1.GetLogRequest) (*logv1.GetLogResponse, error) {
	...
	return &logv1.GetLogResponse{
		...
		CacheCreation_5MTokens: entry.CacheCreation5mTokens,
		CacheCreation_1HTokens: entry.CacheCreation1hTokens,
...
func logEntryToProto(e *biz.LogEntry) *logv1.GetLogResponse {
	return &logv1.GetLogResponse{
		...
		CacheCreation_5MTokens: e.CacheCreation5mTokens,
		CacheCreation_1HTokens: e.CacheCreation1hTokens,
...
func logEntryToMap(e *biz.LogEntry) map[string]interface{} {
	return map[string]interface{}{
		...
		"cache_creation_5m_tokens": e.CacheCreation5mTokens,
		"cache_creation_1h_tokens": e.CacheCreation1hTokens,
		"channel":           e.ChannelID,

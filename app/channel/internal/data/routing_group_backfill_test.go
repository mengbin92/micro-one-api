...
func routingGroupFixture(t *testing.T) (*sql.DB, *gorm.DB) {
	...
	groupSQLFile(t, db, "../../../../migrations/sqlite/092_create_routing_groups.sql", "sqlite3")
	groupSQLFile(t, db, "../../../../migrations/sqlite/095_create_routing_change_outbox.sql", "sqlite3")

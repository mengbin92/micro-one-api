...
func FactsToProto(f *routing.SubjectFacts) *commonv1.RoutingSubjectFacts {
	...
	p := &commonv1.RoutingSubjectFacts{DefaultGroupId: f.DefaultGroupID, PublicGroupAccess: f.PublicGroupAccess, AccessRevision: f.AccessRevision, TokenMode: f.TokenMode, TokenGroupId: f.TokenGroupID, TokenRevision: f.TokenRevision}
...
func FactsFromProto(p *commonv1.RoutingSubjectFacts) *routing.SubjectFacts {
	...
	f := &routing.SubjectFacts{DefaultGroupID: p.DefaultGroupId, PublicGroupAccess: p.PublicGroupAccess, AccessRevision: p.AccessRevision, TokenMode: p.TokenMode, TokenGroupID: p.TokenGroupId, TokenRevision: p.TokenRevision}

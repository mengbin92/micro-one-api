...
> 状态：Linux/amd64 三版本对比已于 2026-08-10 完成，三次原始样本、
> summary、中位数和环境指纹见 `scripts/benchmark/results/p31-amd64/`，结果已回填
> `docs/design/BASELINE.md`。当前版本的后续复测沿用本方法和
> `scripts/benchmark/summarize-regression.py`，不改写这批历史样本。

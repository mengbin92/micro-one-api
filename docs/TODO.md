...
>
> **第一批与第二批已交付**：R1–R4 已纳入 v0.31.1，见[第一批实施记录](./runbooks/first-batch-reliability-2026-09-22.md)；O1–O4 和 O5 正确性修复纳入 [v0.32.0](./releases/release-v0.32.0.md)，审查及隔离验收见[计划第 3 节](./design/next-stage-plan-2026-09-22.md#3-第二批观测与额度解释o)。第二批未部署；生产外部通知送达、OTel 导出、回源成本/Redis 传播延迟仍待验收。下一批 Q1–Q3 按计划推进。
>
